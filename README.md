...
It's an app to search for GIFs on any theme, connected to an API. You can save, organize, and delete each search you perform.
...
_Para HTTPS_
```
https://github.com/TatanLion/Gif-App.git
```
...
Por favor lee el [CONTRIBUTING.md](https://github.com/TatanLion/Gif-App.git) para detalles de nuestro código de conducta, y el proceso para enviarnos pull requests.
